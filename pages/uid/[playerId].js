                    ...
                    <div className='sm:pb-0 pb-[65px]'>
                        ...
                        <div className='py-10 px-4 h-[200px]'>
                            ...
                            <div className='flex justify-center items-center space-x-5 text-white'>
                                    ...
                                    <svg t="1655445801245" className="icon sm:w-[50px] sm:h-[50px] w-[40px] h-[40px]" viewBox="0 0 1024 1024" version="1.1" fill='#02a8e4' xmlns="http://www.w3.org/2000/svg" p-id="1562" width="50" height="50"><path d="M430.59456 494.1504 430.59456 81.93536 7.04 141.18528 7.04 494.1504Z" p-id="1563"></path><path d="M465.88672 494.1504 1016.32 494.1504 1016.32 0 465.88672 77.00864Z" p-id="1564"></path><path d="M430.59456 529.44256 7.04 529.44256 7.04 882.41152 430.59456 941.664Z" p-id="1565"></path><path d="M465.88672 529.44256 465.88672 946.59072 1016.32 1023.59168 1016.32 529.44256Z" p-id="1566"></path></svg>
                                </div>
                            </div>
                        </div>
                        {/* main */}
