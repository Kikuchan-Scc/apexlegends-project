            ...
            <div className='w-[95vw] h-[95vh] bg-[#1b1b53] overflow-hidden px-2 py-2'>
                <div className='lg:flex block h-full'>
                    <div className='lg:w-[20%] w-full flex flex-col items-center'>
                        ...
                        <div className='lg:h-[200px] h-[100px] space-y-2 flex flex-col items-center justify-center'>
                                                ...
                                                <div class="table w-full ">
                                                    <div class="table-header-group">
                                                        <div class="table-row h-[60px] text-white">
                                                            ...
                                                            <div class="table-cell text-left leading-[60px] w-[400px] ">
                                                                <button className='text-white text-opacity-50 hover:text-opacity-100'>
                                                                    <Link href={'/uid/' + e.uid}>查看玩家</Link>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
