                                ...
                                <div className='w-[100%]'>
                                    <div className='grid grid-cols-2'>
                                        {club.data.club.members.map((e) => (
                                            <div className='h-[60px] flex items-center'>{e.name}</div>
                                        ))
                                        }
                                    </div>
                                </div>
